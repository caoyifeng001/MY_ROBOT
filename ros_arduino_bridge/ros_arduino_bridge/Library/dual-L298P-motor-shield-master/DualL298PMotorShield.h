...
class DualL298PMotorShield
{
  ...
  private:
	...
	static const unsigned char _M1PWM  = 2;  	 //M1 left
	static const unsigned char _M1DIR1 = 3;
	static const unsigned char _M1DIR2 = 4;	
    static const unsigned char _M2DIR1 = 5;	   	//M2 right
    static const unsigned char _M2DIR2 = 6;
    static const unsigned char _M2PWM  = 7;
};
